...
var movingPizzas; // make items a global = document.getElementsByClassName('mover');
...
var animate = function () {
  shift = document.body.scrollTop / 1250 + 1;
  update();
};
...
var addMovingPizzas = function () {
  ...
  movingPizzas = movingPizzasContainer.childNodes;
};
